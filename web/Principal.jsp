       ...
       <nav  style="background-color: #B76E79" class="navbar navbar-expand-lg navbar-light ">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=Direccion&accion=Listar" target="myFrame">Dirección</a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=Locales&accion=Listar" target="myFrame">Locales</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=Promocion&accion=Listar" target="myFrame">Promoción</a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=Pedido&accion=Listar" target="myFrame">Pedido</a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=Carrito&accion=default" target="myFrame">Carrito</a>
              </li>
              <li class="nav-item">
          ...
          <div class="dropdown">
            ...
            <div  class="dropdown-menu text-center" aria-labelledby="dropdownButton">
                ...
                <div class="m-4" style="height: 600px">
                    <iframe name="myFrame" src="Home.jsp"  style="height: 100%; width: 100%; border: 1"></iframe>
                </div>
